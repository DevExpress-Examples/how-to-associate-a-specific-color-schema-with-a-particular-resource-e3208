...
Namespace WpfApplication1
    Partial Public Class MainWindow
        ...
        Private resourceColorSchemas As Dictionary(Of Object, SchedulerColorSchema) =
        ...
        Private Sub schedulerControl1_QueryResourceColorSchema(ByVal sender As Object, _
                                                               ByVal e As QueryResourceColorSchemaEventArgs)
        ...
        Private selectedResource As Resource = Resource.Empty
